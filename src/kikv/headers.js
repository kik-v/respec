...
export const name = "kikv/headers";

const kikvDate = new Intl.DateTimeFormat(["nl-NL"], {
  timeZone: "UTC",
  year: "numeric",
  month: "long",
  day: "2-digit",
...
export function run(conf) {
  ...
  conf.title = document.title || "Geen titel";
  ...
  conf.publishHumanDate = kikvDate.format(conf.publishDate);
